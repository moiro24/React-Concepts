...
// GRADIENT BACKGROUND
// ---------------------------------------------------------------------------
// The soft, slowly floating colored blobs behind the auth screen. It's pure
// SVG that reads the theme's --color-* CSS variables, so it recolors itself
// automatically in light/dark mode. No React state — just markup.
// ---------------------------------------------------------------------------
  ...
  <>
    ...
    >
      ...
      <g style={{ animation: "float2 25s ease-in-out infinite" }}>
        ...
        <ellipse cx="50" cy="150" rx="180" ry="120" fill="var(--color-chart-2)" filter="url(#rev_blur2)" opacity="0.8" />
      </g>
    </svg>
  </>
);
